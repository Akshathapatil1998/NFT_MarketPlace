    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white dark:bg-gray-800 shadow-lg rounded-xl p-8">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Collection Name</label>
            <input
              type="text"
          ...
          {/* Symbol Input */}
          <div>
            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Symbol</label>
            <input
              type="text"
          ...
          <button
            ...
            className={`w-full px-4 py-2 text-white font-bold rounded-lg transition ${
              status.includes("Deploying") ? "bg-blue-400 cursor-not-allowed" : "bg-blue-500 hover:bg-blue-600"
