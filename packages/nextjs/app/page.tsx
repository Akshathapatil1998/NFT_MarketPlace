...
const Home: NextPage = () => {
  ...
  return (
    <>
      <div className="min-h-screen bg-[#b9c2c4] text-white">
        {/* Header Section */}
...
const FeatureCard = ({
  ...
  return (
    <div className="flex flex-col bg-[#b9c2c4] shadow-lg px-6 py-12 text-center items-center max-w-sm rounded-3xl transition duration-300 ease-in-out transform hover:scale-105">
